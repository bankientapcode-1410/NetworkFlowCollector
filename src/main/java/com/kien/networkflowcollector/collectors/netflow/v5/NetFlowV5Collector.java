...
@Component
public class NetFlowV5Collector implements FlowCollector {
    ...
    public Set<String> supportedSourceTypes() {
        return Set.of(NetFlowV5Protocol.SOURCE_TYPE);
    }
    ...
    public synchronized void init(CollectorConfig config, FlowPublisher publisher) {
        ...
        this.port = intProperty(properties, "port", DEFAULT_PORT);
    ...
    public synchronized void start() {
        ...
        try {
            ...
            bootstrap.group(newGroup)
                    ...
                    .handler(new NetFlowV5DatagramHandler());
    ...
    private void handlePacket(DatagramPacket packet) {
        ...
        try {
            records = decoder.decode(packet.content(), exporterIp, receivedAt);
        } catch (RuntimeException e) {
    ...
    private final class NetFlowV5DatagramHandler extends SimpleChannelInboundHandler<DatagramPacket> {
