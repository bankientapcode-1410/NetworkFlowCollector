...
public final class ZeekNormalizerSupport {

    private ZeekNormalizerSupport() {}

    public static NormalizedFlow normalizeConnRecord(RawFlowRecord raw) {
        Objects.requireNonNull(raw, "raw");
        if (!ZeekProtocol.CONN_SOURCE_TYPE.equals(raw.sourceType())) {
        ...
        int protocolNumber =
                intFieldOrDefault(fields, "protocol_number", ZeekProtocol.protocolNumber(protocol));
