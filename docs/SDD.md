...
1. **Tạo package mới** `src/main/java/com/kien/networkflowcollector/collectors/jflow`.  
...
flowchart TD
    Start([Bắt đầu])
    Create["Tạo package collectors/&lt;format&gt;"]
...
| ----- | ----- |
| collectors | Java 21, Netty, Kafka Producer, Jackson |
